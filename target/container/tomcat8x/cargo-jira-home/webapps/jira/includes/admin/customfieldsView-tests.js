AJS.test.require(["jira.webresources:viewcustomfields"], function () {
    ...
    module("CustomfieldsPageView", {
        setup: function setup() {
            ...
            $('#qunit-fixture').html("<section class=\"test-custom-fields\"> \n                    <section id=\"customfields-container\"> </section>\n                 </section>");

            this.mockCustomfieldsResponse();
            this.customfieldsPageView = new CustomfieldsPageView({ el: 'section.test-custom-fields' });
        },
